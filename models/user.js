...
const UserSchema = new mongoose.Schema({
    ...
    address: {
        street: {
            type: String,
            required: [false, "Please provide the street address"],
        },
        landmark: {
            type: String,
            required: [false, "Please provide the landmark"],
        },
        city: {
            type: String,
            required: [false, "Please provide the city"],
        },
        state: {
            type: String,
            required: [false, "Please provide the state"],
        },
        country: {
            type: String,
            required: [false, "Please provide the country"],
        },
        pincode: {
            type: Number,
